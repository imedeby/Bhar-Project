    ...
    <main>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tfoot>
          ...
          <tr>
            <td colspan="2"></td>
            <td colspan="2">Net HT</td>
            <td>{{ $factures->net_payer }}</td>
          </tr>
          <tr>
            <td colspan="2"></td>
            <td colspan="2">Avance</td>
            <td>{{ $factures->avance }}</td>
          </tr>
          @if($factures->avance2 != 0 )
          <tr>
            <td colspan="2"></td>
            <td colspan="2">Avance2</td>
            <td>{{ $factures->avance2 }}</td>
          </tr>
          @endif
          <tr>
            <td colspan="2"></td>
            <td colspan="2">Reste</td>
            <td>{{ $reste = $factures->net_payer - ($factures->avance + $factures->avance2) }}</td>
          </tr>
