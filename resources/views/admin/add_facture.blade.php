...
<div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Ajout d'un Bon Du Commande</h4>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="tel" class="form-control" id="mobile" name="mobile" pattern="^\d{8}$" required/>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="number" step="0.01" class="form-control" id="np" name="np"  required />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-4">
                            <input type="number" step="0.01" class="form-control" id="re" name="re"/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                          <textarea class="form-control" id="rem" name="rem" rows="4"></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          <div class="form-check">
                            <label class="form-check-label">
                              <input type="checkbox" id="tva" name="tva" class="form-check-input " value="tva">
                              TVA
                            </label>
                          </div>
                        </div>
